...
extension RouteHelpers on HttpRoute {
  ...
  void reactions({String? emoji, String? userId}) => add(
    HttpRoutePart("reactions", [
  ...
  void discoverySplashes({String? id}) => add(
    HttpRoutePart('discovery-splashes', [if (id != null) HttpRouteParam(id)]),
  );
  ...
  void interactions({String? id, String? token}) => add(
    HttpRoutePart('interactions', [
  ...
  void avatarDecorations({String? id}) => add(
    HttpRoutePart('avatar-decorations', [if (id != null) HttpRouteParam(id)]),
  );
